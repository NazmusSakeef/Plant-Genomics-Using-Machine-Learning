...
y = pd.read_csv("D:/Plant Genomics Using ML/dataset/0_30_6_class.csv") #Class files  #Change it by using your own directory path
...
lr = LogisticRegression(penalty='l2', dual=False, tol=0.0001, C=.62, fit_intercept=True, intercept_scaling=1, class_weight=None, random_state=None, solver='lbfgs', max_iter=200, multi_class='auto', verbose=0, warm_start=False, n_jobs=None, l1_ratio=None)
...
print(accuracy)
recall = cross_val_score(lr, X_train, y_train, cv=10, scoring='recall_macro')
print('Recall', recall)
precision = cross_val_score(lr, X_train, y_train, cv=10, scoring='precision_macro')
print('Precision', precision)
f1 = cross_val_score(lr, X_train, y_train, cv=10, scoring='f1_macro')
print('F1',  f1)
