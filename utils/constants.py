UNIVARIATE_DATASET_NAMES = ['all_plants','phot1_2_phyC','50words', 'Adiac', 'ArrowHead', 'Beef', 'BeetleFly', 'BirdChicken', 'Car', 'CBF',
...
UNIVARIATE_DATASET_NAMES_2018 = ['all_plants','phot1_2_phyC','ACSF1', 'Adiac', 'AllGestureWiimoteX', 'AllGestureWiimoteY', 'AllGestureWiimoteZ',
...
dataset_types = {'all_plants': 'ECG',
    'phot1_2_phyC': 'ECG',
                 'ElectricDevices': 'DEVICE', 'FordB': 'SENSOR',
